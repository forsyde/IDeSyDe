...
object SDFUtils {
  ...
  // )(using Integral[Rational]): Array[Int] =
  ...
  //     val nullVec = svd.getVT().getRow(svdZeroIdx(0)._2) //.map(Rational(_))
  ...
  // )(using Integral[Rational]): Array[Int] = getPASS(topology, Array.fill(topology(0).length)(0))

  // def getPASS(
  //     topology: Array[Array[Int]],
  //     initialTokens: Array[Int]
  // )(using Integral[Rational]): Array[Int] = getPASS(
  //   topology,
  //   initialTokens,
