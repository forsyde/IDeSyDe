...
public interface CanExploreAADPTMWithJenetics {
        ...
        // default
        // InvertibleCodec<AperiodicAsynchronousDataflowToPartitionedTiledMulticore,
        // IntegerGene> ofDecisionModel(
        ...
        // .toList();
        // var pes =
        // decisionModel.partitionedTiledMulticore().hardware().processingElems().stream()
        // .toList();
        // var scheds =
        // decisionModel.partitionedTiledMulticore().runtimes().runtimes().stream().toList();
        // var mems =
        // decisionModel.partitionedTiledMulticore().hardware().storageElems().stream().toList();
        ...
        // var nUsedPEs =
        // decisionModel.processesToRuntimeScheduling().values().stream().distinct().count();
        ...
        // var hostSched =
        // decisionModel.processesToRuntimeScheduling().get(j.process());
        // var hostPe =
        ...
        // var srcHostSched =
        // decisionModel.processesToRuntimeScheduling().get(src.process());
        // var srcHostPe =
        // decisionModel.partitionedTiledMulticore().runtimes().runtimeHost()
        // .get(srcHostSched);
        ...
        // var dstHostSched =
        // decisionModel.processesToRuntimeScheduling().get(dst.process());
        // var dstHostPe =
        // decisionModel.partitionedTiledMulticore().runtimes().runtimeHost()
        // .get(dstHostSched);
        // // var sentDataTime =
        ...
        // return mapping[i] == mapping[j] ? ordering[i] + 1 == ordering[j] :
        // follows.get(i).contains(j);
        // };
        // BiFunction<Integer, Integer, Boolean> mustCycle = (i, j) -> {
        // return mapping[i] == mapping[j] ? ordering[j] == 1 && ordering[i] > 1 :
        // false;
        // };
        ...
        // }
        // }
        // maxCycles[src] = maximumCycleVector[src] > Double.NEGATIVE_INFINITY ?
        // maximumCycleVector[src]
        // : jobWeights[src];
        // }
        ...
        // // for (
        // // group <- m.sdfApplications.sdfDisjointComponents; a1 <- group; a2 <-
        // group;
        // // if a1 != a2;
        ...
        // private final Map<AperiodicAsynchronousDataflow.Job,
        // Set<AperiodicAsynchronousDataflow.Job>> memoizedSucessors;
        // public AperiodicAsynchronousDataflowToPartitionedTiledMulticore
        // decisionModel;
        ...
        // this.decisionModel = decisionModel;
        // runtimes =
        // decisionModel.partitionedTiledMulticore().runtimes().runtimes().stream()
        // .toList();
        // tasks = decisionModel.aperiodicAsynchronousDataflows().stream()
        // .flatMap(x -> x.processes().stream())
        // .collect(Collectors.toList());
