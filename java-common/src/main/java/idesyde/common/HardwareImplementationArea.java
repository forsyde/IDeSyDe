...
/**
 * A decision model to hold the required area that a hardware implementation
 * needs.
 */
public record HardwareImplementationArea(
        ...
        @JsonProperty("required_resources") Map<String, Map<String, Map<String, Long>>> requiredResources,
        @JsonProperty("provided_resources") Map<String, Map<String, Long>> providedResources,
